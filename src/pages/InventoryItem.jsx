...
const InventoryItem = (props) => {
  ...
  const ButtonType = ({ id, item, itemInCart }) => {
    ...
    return <Button customClass="btn_inventory" label={label} onClick={onClick} size={BUTTON_SIZES.SMALL} testId={testId} type={type} />;
  };
          ...
          <div className="inventory_details">
            <div className="inventory_details_container">
              <div className="inventory_details_img_container">
                <img alt={item.name} className="inventory_details_img" src={require(`../assets/img/${item.image_url}`)} />
              </div>
              <div className="inventory_details_desc_container">
                <div className="inventory_details_name large_size">{item.name}</div>
                <div className="inventory_details_desc large_size">{item.desc}</div>
